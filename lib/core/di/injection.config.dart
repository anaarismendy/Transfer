...
import 'package:prueba_tecnica/core/di/hive_module.dart' as _i443;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  Future<_i174.GetIt> init({
    ...
    await gh.lazySingletonAsync<_i738.Box<dynamic>>(
      () => hiveModule.transfersBox,
      instanceName: 'transfers',
      preResolve: true,
    );
    gh.lazySingleton<_i1050.PasswordHasher>(() => _i330.BcryptPasswordHasher());
    gh.lazySingleton<_i1024.SessionLocalDataSource>(
      () => _i1024.SessionLocalDataSource(
        gh<_i738.Box<dynamic>>(instanceName: 'session'),
      ),
    );
    ...
    gh.lazySingleton<_i955.TransferLocalDataSource>(
      () => _i955.TransferLocalDataSource(
        gh<_i738.Box<dynamic>>(instanceName: 'transfers'),
      ),
    );
    gh.lazySingleton<_i104.UserLocalDataSource>(
      () => _i104.UserLocalDataSource(
        gh<_i738.Box<dynamic>>(instanceName: 'users'),
      ),
    );
...
class _$HiveModule extends _i443.HiveModule {}
